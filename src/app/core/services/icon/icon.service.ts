...
export class IconService {
  ...
  private readonly iconPaths: Record<string, string> = {
    ...
    // Import history - Archive box icon
    'import-history': 'M20.25 7.5v10.125c0 .621-.504 1.125-1.125 1.125H4.875A1.125 1.125 0 0 1 3.75 17.625V7.5m16.5 0-1.257-3.771A1.125 1.125 0 0 0 17.928 3H6.072a1.125 1.125 0 0 0-1.065.729L3.75 7.5m16.5 0H3.75m6 4.5h4.5',
    ...
    // Copy icon
    copy: 'M8 5H6a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2v-1M8 5a2 2 0 002 2h2a2 2 0 002-2M8 5a2 2 0 012-2h2a2 2 0 012 2m-3 8h3m-3 4h3',
  };
