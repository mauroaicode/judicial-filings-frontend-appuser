...
import {
  ...
  NotificationDigestHistoryResponse,
  NotificationDigestDetailResponse,
...
export class NotificationDigestHistoryService {
  ...
  getHistory(
    page: number = 1,
    perPage: number = 20,
    filters?: NotificationDigestHistoryFilter
  ...
  /**
   * Detalle de un consolidado (paginado). Reenvía los mismos filtros del listado
   * para que el backend recorte filas (p. ej. términos judiciales).
   */
